...
AGB_by_Plot$change0509 <- with(AGB_plot_sumE, sum_AGB09 - sum_AGB05)
AGB_by_Plot$change0913 <- with(AGB_plot_sumE, sum_AGB13 - sum_AGB09)
AGB_by_Plot$change0513 <- with(AGB_plot_sumE, sum_AGB13 - sum_AGB05)
